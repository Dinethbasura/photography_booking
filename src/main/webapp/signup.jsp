...
<head>
  ...
  <title>Sign Up - Photography Booking</title>

  <!-- Signup Form CSS -->
  <style>
    /* Full-page signup form styles */
    body {
      margin: 0;
      padding: 0;
      display: flex;
      ...
      color: white;
      background-image: url('assets/logcamera.jpg'); /* Background image */
...
<div class="signup-container">
  ...
  <form class="form" onsubmit="handleSignup(event)">
    ...
    <div class="field">
      ...
      <input placeholder="Confirm Password" class="input-field" type="password" id="confirmPassword" required>
    </div>
    <div class="btn">
      <button class="button1" type="submit">Sign Up</button>
      <button class="button2" type="button" onclick="window.location.href='login.jsp'">Back to Login</button>
    </div>
  </form>
</div>
